...
declare -x OVPN_CN=mydomain.dedyn.io
...
declare -x OVPN_DNS_SERVERS=([0]="8.8.8.8")
declare -x OVPN_ENV=/etc/openvpn/ovpn_env.sh
declare -x OVPN_EXTRA_CLIENT_CONFIG=()
declare -x OVPN_EXTRA_SERVER_CONFIG=([0]="push \"dhcp-option DOMAIN DOMAIN.NAME\"")
...
declare -x OVPN_SERVER_URL=udp://mydomain.dedyn.io
